...
from model.Functional_attention import FunctionalMap_Attention_Structured_Mesh_2D
...
class FuncAttn_block(nn.Module):
    ...
    def __init__(
        ...
        self.Attn = FunctionalMap_Attention_Structured_Mesh_2D(hidden_dim, heads=num_heads, dim_head=hidden_dim // num_heads,
