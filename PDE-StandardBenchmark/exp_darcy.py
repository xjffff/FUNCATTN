...
parser.add_argument('--save_name', type=str, default='darcy_2d_UniPDE')
...
def main():
    ...
    if eval:
        ...
        for ep in range(args.epochs):
            ...
            print(
                "Epoch {} , reg_loss:{:.5f} , train_loss:{:.5f} , test_loss:{:.5f}".format(
                    ep, reg, train_loss, rel_err))

            logger.log({
                'epoch': ep,
                'train/l2_loss': train_loss * ntrain,
                'train/deriv_loss': reg * ntrain,
                'test/rel_err': rel_err * ntest,
